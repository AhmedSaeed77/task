...
<center class="fs-1">Edit Album</center>

<form id="uploadFile" class="container " method="post" action = "{{route('album.albumupdate',$album->id)}}"
      enctype="multipart/form-data" id="dropzone">
@csrf
  <div class="mb-3">
    <label for="exampleInputEmail1"> Name </label>
    <input type="text" class="form-control" value="{{$album->name}}" 
