...
var KTThemeMode = function() {
    var e, t = this,
        n = function() { return document.documentElement.hasAttribute("data-theme") ? document.documentElement.getAttribute("data-theme") : null !== localStorage.getItem("data-theme") ? localStorage.getItem("data-theme") : "system" === r() ? o() : "light" },
        i = function(i, r) {
            var l = n();
            "system" === r ? o() !== i && (i = o()) : i !== r && (r = i);
            var s = e ? e.querySelector('[data-kt-element="mode"][data-kt-value="' + r + '"]') : null;
            document.documentElement.setAttribute("data-kt-theme-mode-switching", "true"), document.documentElement.setAttribute("data-theme", i), setTimeout((function() { document.documentElement.removeAttribute("data-kt-theme-mode-switching") }), 300), localStorage.setItem("data-theme", i), s && (localStorage.setItem("data-theme-mode", r), a(s)), i !== l && KTEventHandler.trigger(document.documentElement, "kt.thememode.change", t)
        },
        r = function() { if (!e) return null; var t = e ? e.querySelector('.active[data-kt-element="mode"]') : null; return t && t.getAttribute("data-kt-value") ? t.getAttribute("data-kt-value") : document.documentElement.hasAttribute("data-theme-mode") ? document.documentElement.getAttribute("data-theme-mode") : null !== localStorage.getItem("data-theme-mode") ? localStorage.getItem("data-theme-mode") : "undefined" != typeof defaultThemeMode ? defaultThemeMode : "light" },
...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            ...
            })))), r && (l = r.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(l, r) && r.scroll({ top: KTUtil.getRelativeTopPosition(l, r), behavior: "smooth" }), i && i.addEventListener("hide.bs.collapse", (e => { r.scrollTo({ top: 0, behavior: "instant" }) })))
        }
    }
}();
