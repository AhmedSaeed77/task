        ...
        ! function() {
            ...
            if (e) {
                ...
                var o = (t.size - t.lineWidth) / 2,
                    i = function(e, t, a) { a = Math.min(Math.max(0, a || 1), 1), r.beginPath(), r.arc(0, 0, o, 0, 2 * Math.PI * a, !1), r.strokeStyle = e, r.lineCap = "round", r.lineWidth = t, r.stroke() };
        ...
        t = function(e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    o = { series: [{ name: "Sales", data: [3.5, 5.7, 2.8, 5.9, 4.2, 5.6, 4.3, 4.5, 5.9, 4.5, 5.7, 4.8, 5.7] }], chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 0 }, stroke: { curve: "smooth", show: !0, width: 2, colors: [r] }, xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: r, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { labels: { show: !1 } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, x: { formatter: function(e) { return "Feb " + e } }, y: { formatter: function(e) { return "10" * e + "K" } } }, colors: [KTUtil.getCssVariableValue("--kt-success")], grid: { borderColor: l, strokeDashArray: 4, padding: { top: 0, right: -20, bottom: -20, left: -20 }, yaxis: { lines: { show: !0 } } }, markers: { strokeColor: r, strokeWidth: 2 } };
                e.self = new ApexCharts(t, o), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
        ...
        t = function(e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--kt-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--kt-gray-800"),
                    o = { series: [{ name: "Shipments", data: [1.5, 4.5, 2, 3, 2, 4, 2.5, 2, 2.5, 4, 3.5, 4.5, 2.5] }], chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 0 }, stroke: { curve: "smooth", show: !0, width: 2, colors: [r] }, xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: r, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { labels: { show: !1 } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, x: { formatter: function(e) { return "Feb " + e } }, y: { formatter: function(e) { return "10" * e + "K" } } }, colors: [KTUtil.getCssVariableValue("--kt-success")], grid: { borderColor: l, strokeDashArray: 4, padding: { top: 0, right: -20, bottom: -20, left: -20 }, yaxis: { lines: { show: !0 } } }, markers: { strokeColor: r, strokeWidth: 2 } };
                e.self = new ApexCharts(t, o), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
    return { init: function() { t(e), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t(e) })) } }
...
"undefined" != typeof module && (module.exports = KTCardsWidget19), KTUtil.onDOMContentLoaded((function() { KTCardsWidget19.init() }));
var KTCardsWidget4 = {
    init: function() {
        ! function() {
        ...
        t = function(e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--kt-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--kt-gray-800"),
                    o = { series: [{ name: "Sales", data: [4.5, 5.7, 2.8, 5.9, 4.2, 5.6, 5.2, 4.5, 5.9, 4.5, 5.7, 4.8, 5.7] }], chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 0 }, stroke: { curve: "smooth", show: !0, width: 2, colors: [r] }, xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: r, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { labels: { show: !1 } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, x: { formatter: function(e) { return "Feb " + e } }, y: { formatter: function(e) { return "$" + e + "K" } } }, colors: [KTUtil.getCssVariableValue("--kt-success")], grid: { borderColor: l, strokeDashArray: 4, padding: { top: 0, right: -20, bottom: -20, left: -20 }, yaxis: { lines: { show: !0 } } }, markers: { strokeColor: r, strokeWidth: 2 } };
                e.self = new ApexCharts(t, o), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
    return { init: function() { t(e), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t(e) })) } }
    ...
    var e = function(e, t, a, l) {
        ...
        if (r) {
            var o = parseInt(KTUtil.css(r, "height")),
                ...
                n = { series: [{ name: "Deliveries", data: a }], chart: { fontFamily: "inherit", type: "bar", height: o, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["22%"], borderRadius: 5, dataLabels: { position: "top" }, startingShape: "flat" } }, legend: { show: !1 }, dataLabels: { enabled: !0, offsetY: -28, style: { fontSize: "13px", colors: i }, formatter: function(e) { return e + "K" } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["Grossey", "Pet Food", "Flowers", "Restaurant", "Kids Toys", "Clothing", "Still Water"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--kt-gray-500"), fontSize: "13px" } }, crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--kt-gray-500"), fontSize: "13px" }, formatter: function(e) { return e + "K" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return +e + "K" } } }, colors: [KTUtil.getCssVariableValue("--kt-primary"), KTUtil.getCssVariableValue("--kt-primary-light")], grid: { borderColor: s, strokeDashArray: 4, yaxis: { lines: { show: !0 } } } },
                d = new ApexCharts(r, n),
                m = !1,
                c = document.querySelector(e);
            !0 === l && (d.render(), m = !0), c.addEventListener("shown.bs.tab", (function(e) { 0 == m && (d.render(), m = !0) }))
        }
    };
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        var l = [{ year: "2003", cars: 1587, motorcycles: 650, bicycles: 121 }, { year: "2004", cars: 1567, motorcycles: 683, bicycles: 146 }, { year: "2005", cars: 1617, motorcycles: 691, bicycles: 138 }, { year: "2006", cars: 1630, motorcycles: 642, bicycles: 127 }, { year: "2007", cars: 1660, motorcycles: 699, bicycles: 105 }, { year: "2008", cars: 1683, motorcycles: 721, bicycles: 109 }, { year: "2009", cars: 1691, motorcycles: 737, bicycles: 112 }, { year: "2010", cars: 1298, motorcycles: 680, bicycles: 101 }, { year: "2011", cars: 1275, motorcycles: 664, bicycles: 97 }, { year: "2012", cars: 1246, motorcycles: 648, bicycles: 93 }, { year: "2013", cars: 1318, motorcycles: 697, bicycles: 111 }, { year: "2014", cars: 1213, motorcycles: 633, bicycles: 87 }, { year: "2015", cars: 1199, motorcycles: 621, bicycles: 79 }, { year: "2016", cars: 1110, motorcycles: 210, bicycles: 81 }, { year: "2017", cars: 1165, motorcycles: 232, bicycles: 75 }, { year: "2018", cars: 1145, motorcycles: 219, bicycles: 88 }, { year: "2019", cars: 1163, motorcycles: 201, bicycles: 82 }, { year: "2020", cars: 1180, motorcycles: 285, bicycles: 87 }, { year: "2021", cars: 1159, motorcycles: 277, bicycles: 71 }],
                            r = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "year", startLocation: .5, endLocation: .5, renderer: am5xy.AxisRendererX.new(t, {}), tooltip: am5.Tooltip.new(t, {}) }));
                        r.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), r.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), r.data.setAll(l);
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));

                        function i(e, i, s) {
                            var n = a.series.push(am5xy.LineSeries.new(t, { name: e, xAxis: r, yAxis: o, stacked: !0, valueYField: i, categoryXField: "year", fill: am5.color(s), tooltip: am5.Tooltip.new(t, { pointerOrientation: "horizontal", labelText: "[bold]{name}[/]\n{categoryX}: {valueY}" }) }));
                            n.fills.template.setAll({ fillOpacity: .5, visible: !0 }), n.data.setAll(l), n.appear(1e3)
                        }
                        o.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }), o.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), i("Cars", "cars", KTUtil.getCssVariableValue("--kt-primary")), i("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--kt-success")), i("Bicycles", "bicycles", KTUtil.getCssVariableValue("--kt-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, { orientation: "horizontal", marginBottom: 25, height: 8 }));
                        var s = r.makeDataItem({ category: "2016", endCategory: "2021" });
                        r.createAxisRange(s), s.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-gray-200")), strokeOpacity: .5, strokeDasharray: [3] }), s.get("axisFill").setAll({ fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-200")), fillOpacity: .1 }), s.get("label").setAll({ inside: !0, text: "Fines increased", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 });
                        var n = r.makeDataItem({ category: "2021" });
                        r.createAxisRange(n), n.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-danger")), strokeOpacity: 1, strokeDasharray: [3] }), n.get("label").setAll({ inside: !0, text: "Fee introduced", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 }), a.appear(1e3, 100)
                    };
                    am5.ready((function() { a() })), KTThemeMode.on("kt.thememode.change", (function() { t.dispose(), a() }))
                }
            }
        }()
    }
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    i.labels.template.setAll({ centerX: am5.p100, fontWeight: "500", fontSize: 18, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")), templateField: "columnSettings" }), i.grid.template.setAll({ forceHidden: !0 });
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        r.get("renderer").labels.template.setAll({ paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), r.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), r.data.setAll(l);
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                        o.get("renderer").labels.template.setAll({ paddingLeft: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), o.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                        ...
                        d.bullets.push((function() { return am5.Bullet.new(t, { locationY: 1, sprite: am5.Circle.new(t, { radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), stroke: am5.color(KTUtil.getCssVariableValue("--kt-dark")) }) }) })), n.data.setAll(l), d.data.setAll(l), n.appear(), a.appear(1e3, 100)
                    };
                    am5.ready((function() { a() })), KTThemeMode.on("kt.thememode.change", (function() { t.dispose(), a() }))
                }
            }
        ...
        t = function(e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    o = { series: [{ name: "Spent time", data: [54, 42, 75, 110, 23, 87, 50] }], chart: { fontFamily: "inherit", type: "bar", height: a, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["28%"], borderRadius: 5, dataLabels: { position: "top" }, startingShape: "flat" } }, legend: { show: !1 }, dataLabels: { enabled: !0, offsetY: -28, style: { fontSize: "13px", colors: [l] }, formatter: function(e) { return e } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["QA Analysis", "Marketing", "Web Dev", "Maths", "Front-end Dev", "Physics", "Phylosophy"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--kt-gray-500"), fontSize: "13px" } }, crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--kt-gray-500"), fontSize: "13px" }, formatter: function(e) { return e + "H" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return +e + " hours" } } }, colors: [KTUtil.getCssVariableValue("--kt-primary"), KTUtil.getCssVariableValue("--kt-primary-light")], grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } } };
                e.self = new ApexCharts(t, o), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
    return { init: function() { t(e), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t(e) })) } }
        ...
        function() {
            if ("undefined" != typeof am5) {
                ...
                if (t) {
                    ...
                    am5.ready((function() { a() })), KTThemeMode.on("kt.thememode.change", (function() { e.dispose(), a() }))
                }
            }
        }()
    }
...
var KTChartsWidget22 = function() {
    ...
    return { init: function() { e("#kt_chart_widgets_22_tab_1", "#kt_chart_widgets_22_chart_1", [20, 100, 15, 25], !0), e("#kt_chart_widgets_22_tab_2", "#kt_chart_widgets_22_chart_2", [70, 13, 11, 2], !1) } }
}();
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
                        var a = t.container.children.push(am5xy.XYChart.new(t, { panX: !1, panY: !1, layout: t.verticalLayout })),
                            l = [{ year: "2016", income: 23.5, expenses: 21.1, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }, { year: "2017", income: 26.2, expenses: 30.5, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }, { year: "2018", income: 30.1, expenses: 34.9, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }, { year: "2019", income: 29.5, expenses: 31.1, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }, { year: "2020", income: 30.6, expenses: 28.2, strokeSettings: { strokeWidth: 3, strokeDasharray: [5, 5] }, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }, { year: "2021", income: 40.6, expenses: 28.2, strokeSettings: { strokeWidth: 3, strokeDasharray: [5, 5] }, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }, { year: "2022", income: 34.1, expenses: 32.9, strokeSettings: { strokeWidth: 3, strokeDasharray: [5, 5] }, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) } }],
                            r = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "year", renderer: am5xy.AxisRendererX.new(t, {}) }));
                        r.data.setAll(l), r.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), r.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 });
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, { min: 0, extraMax: .1, renderer: am5xy.AxisRendererY.new(t, {}) }));
                        o.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), o.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                        ...
                        var s = a.series.push(am5xy.LineSeries.new(t, { name: "Expenses", xAxis: r, yAxis: o, valueYField: "expenses", categoryXField: "year", fill: am5.color(KTUtil.getCssVariableValue("--kt-success")), stroke: am5.color(KTUtil.getCssVariableValue("--kt-success")), tooltip: am5.Tooltip.new(t, { pointerOrientation: "horizontal", labelText: "{name} in {categoryX}: {valueY} {info}" }) }));
                        s.strokes.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-success")) }), s.strokes.template.setAll({ strokeWidth: 3, templateField: "strokeSettings" }), s.data.setAll(l), s.bullets.push((function() { return am5.Bullet.new(t, { sprite: am5.Circle.new(t, { strokeWidth: 3, stroke: am5.color(KTUtil.getCssVariableValue("--kt-success")), radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--kt-success-light")) }) }) })), i.columns.template.setAll({ strokeOpacity: 0, cornerRadiusBR: 0, cornerRadiusTR: 6, cornerRadiusBL: 0, cornerRadiusTL: 6 }), a.set("cursor", am5xy.XYCursor.new(t, {})), a.get("cursor").lineX.setAll({ visible: !1 }), a.get("cursor").lineY.setAll({ visible: !1 });
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        s.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), s.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }), s.data.setAll(a);
                        var n = i.yAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "age", renderer: am5xy.AxisRendererY.new(t, { opposite: !0 }) }));
                        n.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--kt-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }), n.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), n.data.setAll(a);
                        ...
                        d.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500")) }), d.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 });
                        var m = i.series.push(am5xy.ColumnSeries.new(t, { name: "Males", xAxis: d, yAxis: s, valueXField: "malePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--kt-success")), clustered: !1 }));
                        ...
                        var c = i.series.push(am5xy.ColumnSeries.new(t, { name: "Males", xAxis: d, yAxis: s, valueXField: "femalePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), clustered: !1 }));
                        ...
                        var f, u = g.children.push(am5.Label.new(t, { text: "United States", fontSize: 14, fontWeight: "500", fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-800")), y: 20, x: am5.p50, centerX: am5.p50 })),
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        l.labels.template.setAll({ textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-700")) }), l.grid.template.setAll({ location: .5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--kt-gray-400") });
                        ...
                        s.strokes.template.setAll({ strokeOpacity: 0 }), s.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), fillOpacity: .5 });
                        var n = a.series.push(am5radar.RadarLineSeries.new(t, { name: "Expense", xAxis: r, yAxis: i, valueYField: "value2", categoryXField: "name", stacked: !0, tooltip: am5.Tooltip.new(t, { labelText: "Revenue: {value1}\nExpense:{value2}" }), fill: am5.color(KTUtil.getCssVariableValue("--kt-success")) }));
                        n.strokes.template.setAll({ strokeOpacity: 0 }), n.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), fillOpacity: .5 });
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        o.grid.template.setAll({ strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--kt-gray-400") }), o.labels.template.setAll({ fontWeight: "500", fontSize: 12, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-700")) });
                        var s = a.series.push(am5radar.RadarLineSeries.new(t, { name: "Revenue", xAxis: r, yAxis: i, valueYField: "value1", categoryXField: "name", fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")) }));
                        s.strokes.template.setAll({ strokeOpacity: 0 }), s.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), fillOpacity: .5 });
                        var n = a.series.push(am5radar.RadarLineSeries.new(t, { name: "Expense", xAxis: r, yAxis: i, valueYField: "value2", categoryXField: "name", stacked: !0, tooltip: am5.Tooltip.new(t, { labelText: "Revenue: {value1}\nExpense:{value2}" }), fill: am5.color(KTUtil.getCssVariableValue("--kt-success")) }));
                        n.strokes.template.setAll({ strokeOpacity: 0 }), n.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), fillOpacity: .5 });
    ...
    init: function() {
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a, l = function() {
                        (a = am5.Root.new(e)).setThemes([am5themes_Animated.new(a)]), (t = a.container.children.push(am5radar.RadarChart.new(a, { panX: !1, panY: !1, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(40), radius: am5.percent(70), arrangeTooltips: !1 }))).set("cursor", am5radar.RadarCursor.new(a, { behavior: "zoomX" })).lineY.set("visible", !1);
                        var l = am5radar.AxisRendererCircular.new(a, { minGridDistance: 30 });
                        l.labels.template.setAll({ textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-800")) }), l.grid.template.setAll({ location: .5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--kt-gray-400") });
                        ...
                        s.strokes.template.setAll({ strokeOpacity: 0 }), s.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), fillOpacity: .5 });
                        var n = t.series.push(am5radar.RadarLineSeries.new(a, { name: "Expense", xAxis: r, yAxis: i, valueYField: "value2", categoryXField: "name", stacked: !0, tooltip: am5.Tooltip.new(a, { labelText: "Revenue: {value1}\nExpense:{value2}" }), fill: am5.color(KTUtil.getCssVariableValue("--kt-success")) }));
                        n.strokes.template.setAll({ strokeOpacity: 0 }), n.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-primary")), fillOpacity: .5 });
                    ...
                    am5.ready((function() { l() })), KTThemeMode.on("kt.thememode.change", (function() { a.dispose(), l() }))
                }
            }
        }()
    }
        ...
        o = function(e, t, a, l, r, o) {
            ...
            if (i) {
                var s = parseInt(KTUtil.css(i, "height")),
                    ...
                    g = { series: [{ name: "Earnings", data: l }], chart: { fontFamily: "inherit", type: "area", height: s, toolbar: { show: !1 } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: .4, opacityTo: .2, stops: [15, 120, 100] } }, stroke: { curve: "smooth", show: !0, width: 3, colors: [c] }, xaxis: { categories: r, axisBorder: { show: !1 }, axisTicks: { show: !1 }, offsetX: 20, tickAmount: 4, labels: { rotate: 0, rotateAlways: !1, show: !1, style: { colors: d, fontSize: "12px" } }, crosshairs: { position: "front", stroke: { color: c, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { tickAmount: 4, max: 4e3, min: 1e3, labels: { show: !1 } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return e + "$" } } }, colors: [c], grid: { borderColor: m, strokeDashArray: 3, yaxis: { lines: { show: !0 } } }, markers: { strokeColor: c, strokeWidth: 3 } };
                e.self = new ApexCharts(i, g);
                var f = document.querySelector(t);
                !0 === o && setTimeout((function() { e.self.render(), e.rendered = !0 }), 200), f.addEventListener("shown.bs.tab", (function(t) {!1 === e.rendered && (e.self.render(), e.rendered = !0) }))
            }
        ...
        t = function() {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--kt-gray-900"),
                    r = KTUtil.getCssVariableValue("--kt-border-dashed-color"),
                    o = { series: [{ name: "LOI Issued", data: [54, 42, 75, 110, 23, 87, 50] }], chart: { fontFamily: "inherit", type: "bar", height: a, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["28%"], borderRadius: 5, dataLabels: { position: "top" }, startingShape: "flat" } }, legend: { show: !1 }, dataLabels: { enabled: !0, offsetY: -28, style: { fontSize: "13px", colors: [l] }, formatter: function(e) { return e } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["E2E", "IMC", "SSMC", "SSBD", "ICCD", "PAN", "SBN"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--kt-gray-500"), fontSize: "13px" } }, crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--kt-gray-500"), fontSize: "13px" }, formatter: function(e) { return e + "M" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return +e + "M" } } }, colors: [KTUtil.getCssVariableValue("--kt-primary"), KTUtil.getCssVariableValue("--kt-primary-light")], grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } } };
                e.self = new ApexCharts(t, o), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
    return { init: function() { t(), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t() })) } }
}();
"undefined" != typeof module && (module.exports = KTChartsWidget38), KTUtil.onDOMContentLoaded((function() { KTChartsWidget38.init() }));
                ...
                if (e) {
                    var t, a = function() {
                        if (t = am5.Root.new(e)) {
                            ...
                            l.labels.template.setAll({ fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-800")) }), r.labels.template.setAll({ fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-800")) });
...
"undefined" != typeof module && (module.exports = KTChartsWidget39), KTUtil.onDOMContentLoaded((function() { KTChartsWidget39.init() }));
...
"undefined" != typeof module && (module.exports = KTChartsWidget40), KTUtil.onDOMContentLoaded((function() { KTChartsWidget40.init() }));
        ...
        t = function() {
            ...
            if (t) {
                var a = t.getAttribute("data-kt-chart-color"),
                    ...
                    i = KTUtil.getCssVariableValue("--kt-" + a),
                    s = KTUtil.getCssVariableValue("--kt-" + a + "-light"),
                    n = { series: [{ name: "Overview", data: [30, 30, 45, 45, 35, 35, 25, 25, 50, 50] }], chart: { fontFamily: "inherit", type: "area", height: l, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } }, plotOptions: {}, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 1 }, stroke: { curve: "smooth", show: !0, width: 3, colors: [i] }, xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1, style: { colors: r, fontSize: "12px" } }, crosshairs: { show: !1, position: "front", stroke: { color: o, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { min: 0, max: 60, labels: { show: !1, style: { colors: r, fontSize: "12px" } } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return e } } }, colors: [s], markers: { colors: s, strokeColor: i, strokeWidth: 3 } };
                e.self = new ApexCharts(t, n), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
    return { init: function() { t(), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t() })) } }
}();
"undefined" != typeof module && (module.exports = KTChartsWidget43), KTUtil.onDOMContentLoaded((function() { KTChartsWidget43.init() }));
        ...
        t = function() {
            ...
            if (t) {
                var a = t.getAttribute("data-kt-chart-color"),
                    ...
                    i = KTUtil.getCssVariableValue("--kt-" + a),
                    s = KTUtil.getCssVariableValue("--kt-" + a + "-light"),
                    n = { series: [{ name: "Overview", data: [20, 37, 22, 45, 20, 50, 25, 57, 40] }], chart: { fontFamily: "inherit", type: "area", height: l, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } }, plotOptions: {}, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 1 }, stroke: { curve: "smooth", show: !0, width: 3, colors: [i] }, xaxis: { categories: ["Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1, style: { colors: r, fontSize: "12px" } }, crosshairs: { show: !1, position: "front", stroke: { color: o, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { min: 0, max: 60, labels: { show: !1, style: { colors: r, fontSize: "12px" } } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return e } } }, colors: [s], markers: { colors: s, strokeColor: i, strokeWidth: 3 } };
                e.self = new ApexCharts(t, n), setTimeout((function() { e.self.render(), e.rendered = !0 }), 200)
            }
        };
    return { init: function() { t(), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t() })) } }
}();
"undefined" != typeof module && (module.exports = KTChartsWidget44), KTUtil.onDOMContentLoaded((function() { KTChartsWidget44.init() }));
...
var KTChartsWidget8 = function() {
    ...
    return {
        init: function() {
            ...
            KTThemeMode.on("kt.thememode.change", (function() { e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a(e, "#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", l, e.rendered), a(t, "#kt_chart_widget_8_month_toggle", "#kt_chart_widget_8_month_chart", r, t.rendered) }))
        }
    }
}();
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        l.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0, fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-300")) }), l.mapPolygons.template.states.create("hover", { fill: am5.color(KTUtil.getCssVariableValue("--kt-success")) }), l.mapPolygons.template.states.create("active", { fill: am5.color(KTUtil.getCssVariableValue("--kt-success")) });
                        var r = a.series.push(am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, include: ["US", "BR", "DE", "AU", "JP"] }));
                        r.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0 }), am5.ColorSet.new(t, {}), r.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--kt-primary"))), r.mapPolygons.template.states.create("hover", { fill: t.interfaceColors.get("primaryButtonHover") }), r.mapPolygons.template.states.create("active", { fill: t.interfaceColors.get("primaryButtonHover") }), a.chartContainer.get("background").events.on("click", (function() { a.goHome() })), a.appear(1e3, 100)
                    };
                    am5.ready((function() { a() })), KTThemeMode.on("kt.thememode.change", (function() { t.dispose(), a() }))
                }
            }
...
"undefined" != typeof module && (module.exports = KTMapsWidget2), KTUtil.onDOMContentLoaded((function() { KTMapsWidget2.init() }));
...
"undefined" != typeof module && (module.exports = KTPlayersWidget1), window.addEventListener("load", (function() { KTPlayersWidget1.init() }));
    ...
    var e = function() {
        ...
        if (e) {
            var t = e.querySelector('[data-kt-element="audio-track-1"]'),
                ...
                g = function(e) { var t = parseInt(e % 60); return parseInt(e / 60 % 60) + ":" + (t < 10 ? "0" : "") + t };
...
var KTSlidersWidget1 = function() {
        ...
        l = function(e, t, a) {
            ...
            if (l && (!0 !== e.rendered || !l.classList.contains("initialized"))) {
                var r = parseInt(KTUtil.css(l, "height")),
                    o = KTUtil.getCssVariableValue("--kt-primary"),
                    i = { series: [a], chart: { fontFamily: "inherit", height: r, type: "radialBar", sparkline: { enabled: !0 } }, plotOptions: { radialBar: { hollow: { margin: 0, size: "45%" }, dataLabels: { showOn: "always", name: { show: !1 }, value: { show: !1 } }, track: { background: KTUtil.getCssVariableValue("--kt-primary-light"), strokeWidth: "100%" } } }, colors: [o], stroke: { lineCap: "round" }, labels: ["Progress"] };
    ...
    return {
        init: function() {
            ...
            r && (r.addEventListener("slid.bs.carousel", (function(e) { 1 === e.to && l(t, "#kt_slider_widget_1_chart_2", 55), 2 === e.to && l(a, "#kt_slider_widget_1_chart_3", 25) })), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a.rendered = !1), l(e, "#kt_slider_widget_1_chart_1", 76), l(t, "#kt_slider_widget_1_chart_2", 55), l(a, "#kt_slider_widget_1_chart_3", 25) })))
        }
    }
}();
...
var KTSlidersWidget3 = function() {
    ...
    return {
        init: function() {
            ...
            o && (o.addEventListener("slid.bs.carousel", (function(e) { 1 === e.to && a(t, "#kt_sliders_widget_3_chart_2", "primary", r) })), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a(e, "#kt_sliders_widget_3_chart_1", "danger", l), a(t, "#kt_sliders_widget_3_chart_2", "primary", r) })))
        }
    }
}();
    ...
    var e = { self: null, rendered: !1 },
        ...
        l = function(e, t, a) {
            ...
            if (l && (!0 !== e.rendered || !l.classList.contains("initialized"))) {
                var r = parseInt(KTUtil.css(l, "height")),
                    o = KTUtil.getCssVariableValue("--kt-danger"),
                    i = { series: [a], chart: { fontFamily: "inherit", height: r, type: "radialBar", sparkline: { enabled: !0 } }, plotOptions: { radialBar: { hollow: { margin: 0, size: "45%" }, dataLabels: { showOn: "always", name: { show: !1 }, value: { show: !1 } }, track: { background: KTUtil.getCssVariableValue("--kt-white"), strokeWidth: "100%" } } }, colors: [o], stroke: { lineCap: "round" }, labels: ["Progress"] };
                e.self = new ApexCharts(l, i), e.self.render(), e.rendered = !0, l.classList.add("initialized")
            }
        };
    return {
        init: function() {
            ...
            r && (r.addEventListener("slid.bs.carousel", (function(e) { 1 === e.to && l(t, "#kt_slider_widget_7_chart_2", 55), 2 === e.to && l(a, "#kt_slider_widget_7_chart_3", 25) })), KTThemeMode.on("kt.thememode.change", (function() { e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a.rendered = !1), l(e, "#kt_slider_widget_7_chart_1", 76), l(t, "#kt_slider_widget_7_chart_2", 55), l(a, "#kt_slider_widget_7_chart_3", 25) })))
        }
    }
}();
"undefined" != typeof module && (module.exports = KTSlidersWidget7), KTUtil.onDOMContentLoaded((function() { KTSlidersWidget7.init() }));
            ...
            (e = document.querySelector("#kt_widget_table_3")) && (t = $(e).DataTable({ info: !1, order: [], paging: !1, pageLength: !1 }), (() => {
                ...
                e.forEach((l => {
                    l.addEventListener("click", (r => {
                        ...
                        e.forEach((e => { e.classList.remove(...a), e.classList.add("text-muted") })), l.classList.remove("text-muted"), l.classList.add(...a), "Show All" === o ? t.search("").draw() : t.search(o).draw()
                    }))
                }))
            })(), a())
        }
    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_table_widget_4_table")) && ((() => {
                ...
                (a = l.cloneNode(!0)).classList.remove("d-none"), l.parentNode.removeChild(l), (t = $(e).DataTable({ info: !1, order: [], lengthChange: !1, pageLength: 6, ordering: !1, paging: !1, columnDefs: [{ orderable: !1, targets: 0 }, { orderable: !1, targets: 6 }] })).on("draw", (function() { s(), o() }))
            })(), document.querySelector('[data-kt-table-widget-4="search"]').addEventListener("keyup", (function(e) { t.search(e.target.value).draw() })), l(), o())
        }
    }
}();
                    ...
                    "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") && (() => {
                        ...
                        var a = Date.now(),
                            ...
                            i = {
                                ...
                                template: function(e) { const t = e.users; let a = ""; return t.forEach((e => { a += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${l+e}" alt="" /></div>` })), `<div class="rounded-pill bg-light-${e.color} d-flex align-items-center position-relative h-40px w-100 p-2 overflow-hidden">\n                    <div class="position-absolute rounded-pill d-block bg-${e.color} start-0 top-0 h-100 z-index-1" style="width: ${e.progress};"></div>\n        \n                    <div class="d-flex align-items-center position-relative z-index-2">\n                        <div class="symbol-group symbol-hover flex-nowrap me-3">\n                            ${a}\n                        </div>\n        \n                        <a href="#" class="fw-bold text-white text-hover-dark">${e.content}</a>\n                    </div>\n        \n                    <div class="d-flex flex-center bg-body rounded-pill fs-7 fw-bolder ms-auto h-100 px-3 position-relative z-index-2">\n                        ${e.progress}\n                    </div>\n                </div>        \n                ` },
